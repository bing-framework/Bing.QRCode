...
::QRCode
dotnet pack src/Bing.QRCode -c Release -o nuget_packages
dotnet pack src/Bing.QRCode.QRCoder -c Release -o nuget_packages
dotnet pack src/Bing.QRCode.ZXing -c Release -o nuget_packages
